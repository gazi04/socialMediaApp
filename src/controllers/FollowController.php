...
class FollowController{
  ...
  public function followOrUnfollowUser($followerUserId, $followingUserId){
    if($this->isFollowing($followerUserId, $followingUserId)){
      return $this->followModel->unfollowUser($followerUserId, $followingUserId) == true ? "Follow": null; 
    }

    return $this->followModel->followUser($followerUserId, $followingUserId) == true ? "Unfollow": null; 
  }
